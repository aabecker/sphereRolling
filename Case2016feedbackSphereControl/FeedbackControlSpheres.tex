...
For the purpose of using quaternions to express the rotation in $\R^3$ space, all quaternions we use must be unit quaternions. Therefore, \eqref{eq:Quaternion} can represent a rotation only if $\sqrt{a^2+u_x^2+u_y^2+u_z^2}=1$.
...
The \emph{Hamilton products} is a common multiplication between quaternions. The result of this kind of multiplication is given by distributive law and basic operation of imaginary unit and operation of real numbers. The \emph{Hamilton products} between $(a_1+b_1{\bf i}+c_1{\bf j}+d_1{\bf k})$ and $(a_2+b_2{\bf i}+c_2{\bf j}+d_2{\bf k})$ is given by the following expression:
\begin{align*}\nonumber
a_1a_2+a_1b_2{\bf i}+a_1c_2{\bf j}+a_1d_2{\bf k}+\\ b_1a_2{\bf i}+b_1b_2{\bf i}^2+b_1c_2{\bf ij}+b_1d_2{\bf ik}+\\ c_1a_2{\bf j}+c_1b_2{\bf ji}+c_1c_2{\bf j}^2+c_1d_2{\bf jk}+\\ d_1a_2{\bf k}+d_1b_2{\bf ki}+d_1c_2{\bf kj}+d_1d_2{\bf k}^2
\end{align*}
where $a_1$,$a_2$,$b_1$,$b_2$,$c_1$,$c_2$,$d_1$,$d_2$ are all real numbers and the basic multiplication between imaginary units is determined by the following:
\begin{align}\nonumber
{\bf i}^2={\bf j}^2={\bf k}^2={\bf ijk}=-1
\end{align}

Using this we can simplify the generic \emph{Hamilton products} between $(a_1+b_1{\bf i}+c_1{\bf j}+d_1{\bf k})$ and $(a_2+b_2{\bf i}+c_2{\bf j}+d_2{\bf k})$ to the following form:
\begin{align*}\nonumber
a_1a_2-b_1b_2-c_1c_2-d_1d_2\\
+(a_1b_2+b_1a_2+c_1d_2-d_1c_2){\bf i}\\
+(a_1c_2-b_1d_2+c_1a_2+d_1b_2){\bf j}\\
+(a_1d_2+b_1c_2-c_1b_2+d_1a_2){\bf k}
\end{align*}
